  ...
  return [
    {
      ...
      event_name: 'Campus Event - Tommie Buildfest Lunch Leftover',
      description: 'Leftover pasta (penne with marinara, mac and cheese) in foil trays and green salads in plastic containers. Pick up in ASC (Anderson Student Center).',
      quantity: '~20–25 servings (2 pasta trays + 2 large salad containers, serving spoons/tongs included)',
      photo_url: '/food-rescue/campus-buildfest-pasta-salad.png',
      location: 'Pick up in ASC — Anderson Student Center, St. Paul campus',
      location_lat: null,
      location_lng: null,
      pickup_type: 'both',
      expiry_time: expiry1,
    ...
    },
    {
      ...
      description: 'Leftover dessert spread — donuts (glazed, chocolate, pistachio), donut holes, and assorted pastries on tiered stands. Fresh and ready to share.',
      quantity: 'Dozens of pieces — 40+ donuts and pastries (serves 30–50 for dessert)',
      photo_url: '/food-rescue/wedding-baked-goods.png',
    ...
    },
    {
      ...
      description: 'Unclaimed meal sets: roasted chicken, french fries, white rice, side salad, and dipping sauces in takeout containers. Ready to go.',
      quantity: '~12 meal sets (each set serves 2–4 people — chicken, fries, rice, salad, sauces)',
      photo_url: '/food-rescue/corporate-chicken-rice-fries.png',
      location: null,
      location_lat: null,
      location_lng: null,
    ...
    },
    {
      ...
      description: 'Grilled chicken breasts in foil pans — seasoned, golden-brown, ready to serve. Leftover from Sunday potluck.',
      quantity: '~25–30 chicken breast pieces (serves 25–30)',
      photo_url: '/food-rescue/church-potluck-chicken.png',
      location: null,
      location_lat: null,
      location_lng: null,
